...
const plans = [
  {
    name: "Explorer",
    description: "Perfect for small ARK communities",
    monthlyPrice: 12.99,
    features: [
      "6 GB RAM",
      "Up to 20 Players",
  ...
  {
    name: "Tamer",
    description: "For medium-sized ARK communities",
    monthlyPrice: 24.99,
    features: [
      "12 GB RAM",
      "Up to 50 Players",
  ...
  {
    name: "Alpha Tribe",
    description: "For large ARK communities",
    monthlyPrice: 39.99,
    features: [
      "24 GB RAM",
      "Up to 100 Players",
...
export default function ArkPricing() {
  return (
    <div>
      <div className="text-center mb-12">
        <h3 className="text-3xl font-bold text-white mb-4">ARK: Survival Evolved Server Hosting</h3>
        <p className="text-gray-400 max-w-2xl mx-auto">
          Tame dinosaurs and build your empire on a private ARK server. Easy mod installation, regular backups, and
          cluster support.
        </p>
      </div>
      ...
      <div className="mt-12 text-center">
        <p className="text-gray-400 mb-6">
          Need a custom ARK server configuration? <br className="md:hidden" />
