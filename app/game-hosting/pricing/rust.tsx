...
const plans = [
  {
    name: "Survivor",
    description: "Perfect for small Rust communities",
    monthlyPrice: 9.99,
    features: [
      "4 GB RAM",
      "Up to 50 Players",
  ...
  {
    name: "Raider",
    description: "For medium-sized Rust communities",
    monthlyPrice: 19.99,
    features: [
      "8 GB RAM",
      "Up to 100 Players",
  ...
  {
    name: "Warlord",
    description: "For large Rust communities",
    monthlyPrice: 34.99,
    features: [
      "16 GB RAM",
      "Up to 200 Players",
  ...
  return (
    <div>
      <div className="text-center mb-12">
        <h3 className="text-3xl font-bold text-white mb-4">Rust Server Hosting</h3>
        <p className="text-gray-400 max-w-2xl mx-auto">
          Survive the harsh world of Rust with your own customizable server. Easy plugin installation, regular backups,
          and DDoS protection.
        </p>
      </div>
      ...
      <div className="mt-12 text-center">
        <p className="text-gray-400 mb-6">
          Need a custom Rust server configuration? <br className="md:hidden" />
