...
const plans = [
  {
    name: "Viking",
    description: "Perfect for small Valheim groups",
    monthlyPrice: 7.99,
    features: [
      "4 GB RAM",
      "Up to 10 Players",
  ...
  {
    name: "Odin",
    description: "For medium-sized Valheim communities",
    monthlyPrice: 14.99,
    features: [
      "8 GB RAM",
      "Up to 20 Players",
  ...
  {
    name: "Valhalla",
    description: "For large Valheim communities",
    monthlyPrice: 24.99,
    features: [
      "16 GB RAM",
      "Up to 30 Players",
...
export default function ValheimPricing() {
  return (
    <div>
      <div className="text-center mb-12">
        <h3 className="text-3xl font-bold text-white mb-4">Valheim Server Hosting</h3>
        <p className="text-gray-400 max-w-2xl mx-auto">
          Create your Viking world with friends on a dedicated Valheim server. Easy setup, mod support, and regular
          backups.
        </p>
      </div>
      ...
      <div className="mt-12 text-center">
        <p className="text-gray-400 mb-6">
          Need a custom Valheim server configuration? <br className="md:hidden" />
